...
$model_name_or_model_dir = "pretrained_models/iic/speech_seaco_paraformer_large_asr_nat-zh-cn-16k-common-vocab8404-pytorch"

$train_data = "data\train.jsonl"
$val_data   = "data\valjsonl"  
